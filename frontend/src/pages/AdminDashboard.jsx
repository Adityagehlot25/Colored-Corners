      ...
      <div style={{ padding: '40px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {activeTab === 'overview' && !loading && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
            ...
            <div style={glassCardStyle}>
              ...
              <p style={{ color: '#666', fontSize: '12px', margin: '8px 0 0 0' }}>Verified sellers</p>
            </div>
          </div>
        )}
              ...
              <div>
                ...
                {users.map(user => (
                  <div key={user.id} style={tableRowStyle}>
                    ...
                    <div style={{ fontSize: '12px', color: user.emailStatus === 'VERIFIED' ? '#66BB6A' : '#FFA726' }}>
                      {user.emailStatus}
                    </div>
                    <button 
        ...
        {activeTab === 'audit' && (
          <div style={{
            ...
            <p style={{ color: '#888' }}>📋 Your new tracking system will populate here when implemented.</p>
            <p style={{ color: '#666', fontSize: '12px' }}>Tracks: Admin actions, user suspensions, role changes, and sensitive operations.</p>
          </div>
        )}
      </div>
    </div>
